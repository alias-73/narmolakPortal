...
class pos_jaygozini_pageState extends State<list_jaygozini_page> {
  ...
  Future<List<JaygoziniModel>>_getData() async {
    i++;
    if (i <2) {
     response = await OnlineServices.getReplaceList({"agentcode" : widget._Agentdata.last.agentCode, "usercode" : widget._Agentdata.last.userCode} );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(preferredSize: Size.fromHeight(Comp.appBarHeight) ,child: Comp.app_bar("لیست جایگزینی","", Icons.edit, (){})),
        ...
        children: [
          Column(
            children: [
              ...
              Expanded(child:
                FutureBuilder<List<JaygoziniModel>>(future: _getData(),
                builder: (context, AsyncSnapshot<List<JaygoziniModel>> snapshot) {
                  if (snapshot.hasData) {
          ...
          Comp.loadingList_shimmer3(size.height , size.width) : Center()
        ],
      ),
      floatingActionButton: FloatingActionButton(
        child: Icon(Icons.add),
        onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (context) => Directionality(textDirection: TextDirection.rtl, child: newReplace_page(widget._Agentdata))));
        },
      ),
    );
  }
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text( _data[index].serialold == null ? "-" : _data[index].serialold,
                                style: TextStyle(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Flexible(child: Text( _data[index].serialnew== null ? "-" :  _data[index].serialnew,
                                style: TextStyle(
                                    color: primary, fontSize: 13, letterSpacing: .3))),
                          ],
                        ),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text( _data[index].sanad == null ? "-" : _data[index].sanad,
                                style: TextStyle(
                                    color: primary, fontSize: 13, letterSpacing: .3)),
                          ],
                        ),
