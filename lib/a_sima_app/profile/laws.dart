...
class pageState extends State<laws> {
  String law = "";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(preferredSize: Size.fromHeight(Comp.appBarHeight) ,child: Comp.app_bar("قوانین و مقررات","", Icons.edit, (){})),
