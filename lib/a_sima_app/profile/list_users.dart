...
class register_pos_pageState extends State<users_page>
  ...
  Future<List<UserModel2>> _getData() async {
    ...
    i++;
    if (i < 2) {
      response = await OnlineServices.getUserList2(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: PreferredSize(
            ...
            child: Comp.app_bar("لیست کاربران فعال", "", Icons.edit, () {})),
        key: _scaffoldKey,
        backgroundColor: Theme.of(context).primaryColor,
        resizeToAvoidBottomInset: true,
        body: Stack(
          children: [
            FutureBuilder<List<UserModel2>>(
              future: _getData(),
  ...
  Widget buildList(BuildContext context, int index) {
    ...
    _deleteImageFromCache(
        "https://sima-pay.com//upload/Image/Agent/${widget._Agentdata.last.agentCode}${_data[index].usercode}.jpg");
        ...
        child: ListTile(
          ...
          subtitle: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "آماده تخصیص: " + _data[index].takhsis,
                        style: TextStyle(fontSize: 13),
                      ),
                    ],
                  ),
              ...
              _data[index].usercode != "0"
                  ? ElevatedButton(
                      onPressed: () {
                        _SetTargetDialog(_data[index].usercode);
                      },
                      style: ButtonStyle(
                  ...
                  : ElevatedButton(
                      ...
                      style: ButtonStyle(
                        backgroundColor:
                            MaterialStateProperty.all(Color(0x3000000)),
          ...
          leading: Column(
            children: [
              ...
              Text(
                _data[index].usercode.toPersianDigit(),
                style: TextStyle(
                  color: Colors.teal,
  ...
  Future<String> getIMG(String code) async {
    String response = await OnlineServices.getIMG(
        {"agentcode": widget._Agentdata.last.agentCode, "usercode": code});
    return response;
  }
}
