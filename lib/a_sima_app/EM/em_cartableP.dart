...
class em_cartableP_page extends StatefulWidget {
  List<AgentModel> _Agentdata = [];

  em_cartableP_page(this._Agentdata);

  @override
  State<StatefulWidget> createState() => pasargad_pageState();
}

class pasargad_pageState extends State<em_cartableP_page> {
  final _scaffoldKey = GlobalKey<ScaffoldState>();
  List<PasargadModel> _data = [];
  int i = 0;
  ...
  bool isFree = false;
  List<PasargadModel> _data2 = [];
  late Map response;

  Future<List<PasargadModel>> _getData() async {
    i++;
    if (i < 2) {
     // response = await OnlineServices.pasargad({"agentcode": "10047", "usercode": "0"});
      response = await OnlineServices.pasargad({"agentcode" : widget._Agentdata.last.agentCode,"usercode" : widget._Agentdata.last.userCode} );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      key: _scaffoldKey,
      appBar: PreferredSize(preferredSize: Size.fromHeight(Comp.appBarHeight) ,child: Comp.app_bar("کارتابل Em","assets/images/pasargad.png", Icons.edit, (){})),
        ...
        children: [
          Column(
            children: [
              ...
              Expanded(
                  child: FutureBuilder<List<PasargadModel>>(
                future: _getData(),
                builder:
                    (context, AsyncSnapshot<List<PasargadModel>> snapshot) {
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  height: size.height * .06,
                  child: ElevatedButton(
                      onPressed: () { Comp.show_short_info2(size.width, _data[index].address);  },
                      style: ButtonStyle(padding: MaterialStateProperty.all(EdgeInsets.symmetric(vertical: 9)),backgroundColor: MaterialStateProperty.all(Color(0xfffac80a))),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: [
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  height: size.height * .06,
                  child: ElevatedButton(
                      onPressed: () { Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => Directionality(textDirection: TextDirection.rtl, child: sabt_page(_data[index].shenase,widget._Agentdata,"پاسارگاد"))));
                      },
                      style: ButtonStyle(padding: MaterialStateProperty.all(EdgeInsets.symmetric(vertical: 9)),backgroundColor: MaterialStateProperty.all(Color(0xffE2E2E2))),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
