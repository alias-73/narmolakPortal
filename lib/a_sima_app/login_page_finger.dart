...
// ///
//
// class login_page_finger extends StatefulWidget {
//   @override
//   State<StatefulWidget> createState() => sampleState();
// }
//
// class sampleState extends State<login_page_finger> with SingleTickerProviderStateMixin{
...
//       isAuth = true;
//       setState(() {});
//       //  i == 0 ? Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => Directionality(textDirection: TextDirection.rtl, child: login_page_finger()))) :
...
//         localizedReason: 'احراز هویت',
//       );if(isAuth){sendDataForLogin3();}print(isAuth);}on PlatformException catch(e){print(e);}}
//
...
//
//                         isBio == true ?
//                             GestureDetector(child: Icon(Icons.fingerprint,size: 100,),onTap: (){_getAuth();},)
...
//         SystemNavigator.pop();},
//       text: "لطفا آخرین نسخه نرم افزار را از مدیر دریافت نمایید",
//       backgroundColor: Colors.white,
//     );
//   }
//
