  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
          ...
          child: Comp.app_bar("درخواست تغییر حساب", "", Icons.edit, () {})),
      body: SingleChildScrollView(
        child: Stack(
          children: [
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: IconButton(
                          ...
                          onPressed: () {
                            if (_key1.currentState!.value.toString().length >
                                1) {
                              loading = true;
                              setState(() {});
                              i = 0;
                    ...
                    Container(
                        width: size.width * .75,
                        child: Comp.editBox1(
                            context, 2, 0, "ترمینال", Icons.title, _key1, "")),
                  ],
                ),
                Visibility(
                  child: Column(
                    children: [
                      ...
                      Comp.editBox3(
                          context, "نام پذیرنده", Icons.person_outline, name),
                      Comp.editBox3(
                          context, "نام بانک", Icons.location_city, bank),
                      Comp.editBox3(context, "شعبه", Icons.store, shobe),
                      Comp.editBox3(context, "شماره حساب",
                          Icons.drive_file_rename_outline, hesab),
                      Comp.editBox3(
                          context, "شماره شبا", Icons.monetization_on, sheba),
                      Comp.editBox3(
                          context, "سند", Icons.adjust_outlined, sanad),
                      Center(
                        child: Padding(
                          child: Text("اطلاعات جدید",
                              style: TextStyle(
                                  fontSize: 18,
                                  color: Colors.teal,
                                  decoration: TextDecoration.underline)),
                        ...
                        children: <Widget>[
                          ...
                          Container(
                              ...
                              margin: EdgeInsets.only(
                                  right: 35, left: 35, bottom: 6),
                              width: size.width,
                              padding: EdgeInsets.only(right: 60, left: 20),
                              child: DropdownButton<String>(
                                  isExpanded: true,
                                  underline: Container(),
                                  items: _bankValue.map((String val) {
                        ...
                        children: <Widget>[
                          ...
                          Container(
                              ...
                              child: DropdownButton<String>(
                                  isExpanded: true,
                                  underline: Container(),
                                  items: _shobeValue.map((String val) {
                                    return DropdownMenuItem<String>(
                                      value: val,
                                      child: Text(val),
                                    );
                      ...
                      Comp.editBox1(context, 0, 0, "شماره حساب",
                          Icons.drive_file_rename_outline, _key4, ""),
                      Comp.editBox1(context, 0, 24, "شماره شبا",
                          Icons.monetization_on, _key5, ""),
                      Comp.fullBtn(size, "ثبت تغییرات",
                          Icons.drive_file_rename_outline, fun),
                      SizedBox(
                        height: 20,
                      )
                    ],
            ...
            loading == true
                ? Comp.showLoading(size.height, size.width)
                : Center()
          ],
        ),
      ),
              ...
              child: ListBody(
                children: <Widget>[
                  Directionality(
                      ...
                      child: Text(
                          'درخواست تغییر اطلاعات حساب با موفقیت ثبت شد.\n منتظر تایید کارشناسان ما باشید.'))
                ],
              ),
            ),
            actions: <Widget>[
                    ...
                    Navigator.pushReplacement(
                        ...
                        MaterialPageRoute(
                            builder: (BuildContext context) => Directionality(
                                textDirection: TextDirection.rtl,
                                child: editedReqChange_page(widget._data))));
                  },
                  child: Text(
                    "تایید",
                    style: TextStyle(
              ...
              child: ListBody(
                children: <Widget>[
                  Directionality(
                      textDirection: TextDirection.rtl,
                      child: Text(
                          'امکان تغییر مشخصات حساب برای سوئیچ ایران کیش امکان پذیر نمی باشد.'))
                ],
              ),
            ),
            actions: <Widget>[
